...
//getting friends requests on notification page that are in pending or accepted state
...
//getting the requests sent by the user so that user don't have to send the requests again to the same user
